...
public interface ChatApi<PRINCIPAL> {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = "Successfully chats creating"),
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = "Successfully count getting"),
    ...
    @GetMapping(value = "/{chat-id}/messages/count",
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = "Successfully messages getting"),
        @ApiResponse(responseCode = "404", description = "Chat not found",
            content = {@Content(mediaType = "application/json",
                schema = @Schema(implementation = ErrorResponse.class))
            }),
